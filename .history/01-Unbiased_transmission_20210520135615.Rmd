...
ggplot(data = output, aes(x = timestep, y = proportion_of_trait_a)) +
  ...
  ylim(c(0, 1)) +
  theme_bw() +
  labs(y = "proportion of individuals with trait A")
```
