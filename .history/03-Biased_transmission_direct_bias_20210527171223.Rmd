...
（余談として、文化進化において上記であげたような似たような用語の乱立はよくある。だからこそモデリングが極めて有用なのである。言葉による説明は曖昧で、書き手はしばしば自分の表現に隠れた前提やその曖昧さに気づかないままである。「文化選択cultural selection」という言葉を、ほかの人の文章では全く違う意味で使われている、ということに気づかずに使ってしまう、ということがありえてしまう。いっぽうモデリングにおいては、構築する者がある特定の用語やプロセスで何を意味するかを厳密に設定しなければならない。バイアスのある伝達を説明するために上記のような言葉を使うこともできるにはできるが、それをモデリングし、すべての前提を明示することでのみ、ほんとうの意味で明確な説明となるのだ。）
