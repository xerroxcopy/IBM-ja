...
generation = 1$から$generation = generations$までの各世代において、人数$population_size$の個人は同じく人数$population_size$の新しい個人に入れ替えられる。今回は個々人がランダムに誰かから形質をコピーするのではなく、新しい個人は一つ前の世代の文化的形質をそのままコピーする。これは次のような状況とも考えられる。つまり、
