...
しかし、異なる$A$と$B$の頻度で開始したらどうなるのだろう？たとえば、$proportion\_of\_trait\_a = 0.1$とか$proportion\_of_\trait\_a = 0.9$であったら？$A$は消えてしまうのだろうか？バイアスのない変異は、バイアスのない伝達であるModel 1でみたように、$proportion\_of\_trait\_a$を初期値近辺で維持するのか？
