...
原書を訳すだけでなく、Rスクリプトの可読性の向上、シンプル化、高速化も行っているため、Rスクリプトは大幅に改変されている。最終的に同じ挙動をするように注意を払っているが、その正確性は保証できないため、原書と全く厳密に同等のスクリプトを使いたい場合、原書を参照してほしい。また発展的な内容として、実際の論文出版の際に役立ちそうなプロット方法の例を追加して掲載している章がある。近年日本語で出版された、文化進化諸研究で用いられる様々な数理を網羅している田村（2020）に対応する内容がある場合、その結果の再現も試みている。
...
ここで重要なのは、文化進化が生物進化と同一のものであると捉える必要がないことだ。細部には、二者には多くの違いがある。明らかな例をあげよう。われわれは両親からしかDNAを受け継がないのに比べ、さまざまなソースからアイディアを得ることができる：教師、インターネット上の見知らぬ人、死没して久しい著者の著作、親など。文化進化の研究者はモデルを構築したり調査をしたりして、こういった細部の差異を明らかにしようとしている。本書の最終章では、
